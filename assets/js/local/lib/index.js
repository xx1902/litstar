! function(e, t) {
	...
	return function(e) {
		...
		var n = i(5),
			...
			K = function(e, t, i) {
				return e === z && K(B, t, i), y(e), t = _(t, !0), y(i), r(V, t) ? (i.enumerable ? (r(e, I) && e[I][t] && (e[I][t] = !1), i = C(i, {
					enumerable: x(0, !1)
			...
			lu = function e(t) {
				if (!h.a.prototype.$isServer) {
					...
					t.onClose = function() {
						...
						data: t
					})).id = n, ca(su.message) && (su.$slots.default = [su.message], su.message = null), su.$mount(), document.body.appendChild(su.$el);
					var r = t.offset || 20;
